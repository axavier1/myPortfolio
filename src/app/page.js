...
export default function Home() {
  ...
  return (
    <body className={darkMode ? "dark" : ""}>
      <div className="bg-white px-10 min-h-screen md:px-20 lg:px-40 dark:bg-gray-900">
        <nav className="py-10 mb-12 flex justify-between">
          <h1 className="text-xl">myPortfolio</h1>
          <ul className='flex items-center justify-be flex-row lg:gap-4 md:gap-4'>
            <li className='hover:text-teal-700 px-2 dark:hover:text-[#67E0FE]'> <a href='#projects' style={scroll}>Projects</a> </li>
            <li className='hover:text-teal-700 px-2 dark:hover:text-[#67E0FE]'> <a href='#contact'>Contact</a> </li>
          </ul>
          <ul className="flex items-center">
            <li><BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className="cursor-pointer text-2xl" /></li>
            <li className="transition ease-in-out delay-150 hover:scale-110">
              <a className="bg-gradient-to-r from-teal-700 to-teal-500 text-white px-4 py-2 rounded-lg ml-8 focus:ring ring-black ring-opacity-10 " href="#">
                Resume
              </a>
            </li>
          </ul>
        ...
        <main>
          <section className="text-center p-10 pb-4">
            ...
            <h3 className="text-gray-800 pr-8 text-2xl py-2 md:text-3xl dark:text-">
            <Typewriter
              onInit={(typewriter) => {
          ...
          <i className="text-5xl flex justify-center gap-16 pb-3 text-gray-800 dark:text-[#e0d6c8]">
            <a className="transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:text-teal-500 duration-300" href="https://github.com/axavier1">
              <AiFillGithub/>
            </a>
            <a className="transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:text-teal-500 duration-300" href="https://www.linkedin.com/in/anthonyxavier1/">
              <AiFillLinkedin/>
            </a>
          </i>
          ...
          <section>
            <div>
              <h3 className='text-2xl py-3 mb-3'>Services I Offer</h3>
              ...
              <ul className='text-lg py-2 leading-8 text-grey-800 text-justify list-disc ml-9 '>
                ...
                <li className='my-4'> <span className='text-teal-500 dark:text-[#67E0FE]'>Data Analysis and Extraction  </span> : With my knowledge in Python, data science, and machine learning, I can assist businesses in extracting meaningful insights from large datasets, performing exploratory data analysis, and developing predictive models. </li>
          ...
          <section className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
              <div className="flex justify-center flex-col items-center">
                <picture>
                  <source srcset="../assets/images/mobile-testing-and-group-discussion(dark).png" 
                  media="(prefers-color-scheme: dark)"
                  />
                  <img src={mobileTestL} width={200} height={200}/>
                </picture>
                <h3 className="text-lg font-medium pt-8 pb-2">24/7 Support & Communication</h3>
                <p className="py-2">
                  Experience seamless communication, available for your questions, and stay informed about your project's status. 
                </p>
                <h4 className="pt-4 pb-2 text-teal-500 dark:text-[#67E0FE]">Reach me on:</h4>
            ...
            <div className="text-center shadow-lg  p-10 rounded-xl my-10">
              <div className="flex justify-center flex-col items-center">
                ...
                <h3 className="text-lg font-medium pt-8 pb-2">Cutting-edge Tech, Impressive Results.</h3>
                <p className="py-2">
            ...
            <div className="text-center shadow-lg  p-10 rounded-xl my-10">
              <div className="flex justify-center flex-col items-center">
                ...
                <h3 className="text-lg font-medium pt-8 pb-2">Dedicated to your success.</h3>
                <p className="py-2">
                  With unwavering diligence and a commitment to excellence, I dedicate myself to ensuring your project's success, meeting both your standards and mine.                </p>
                <h4 className="pt-4 pb-2 text-teal-500 dark:text-[#67E0FE]">Reach me on:</h4>
                <p className="text-gray-800 py-1">Lorem ipsum</p>
                <p className="text-gray-800 py-1">Lorem ipsum</p>
                <p className="text-gray-800 py-1">Lorem ipsum</p>
          ...
          <section className="p-8 mt-8 max-w-lg mx-auto" id="contact">
            <h1 class="text-4xl text-gray-800 sm:text-4xl font-bold mb-4 dark:text-[#e0d6c8]">
              Contact Form
            </h1>
            <form>
              <div className="p-2 w-full">
                <div className="relative">
                  ...
                  {name ? (
                    <p className="errMsg text-red-600">Your name should have more then 3 letters</p>
                  ) : (
                    <></>
                  )}
                </div>
                <div className="relative my-5">
                  ...
                  <input type="email" id="email" name="email" required="" placeholder="youremail@example.com" className=" w-full bg-white rounded border border-gray-400 focus:border-teal-500 focus:bg-white focus:ring-2 focus:ring-teal-200 text-base outline-none text-gray-900 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out" onBlur={checkEmail}/>
                  {email ? <p className="errMsg text-red-600">Please enter a valid Email</p> : <></>}
                </div>
                <div className="relative">
                  <label for="message" class="leading-7 py-4 text-lg text-gray-800">Message</label>
                  <textarea id="message" name="message" required=""
                    ...
                    onBlur={checkText}
                  ></textarea>
                  {text ? <p className="errMsg text-red-600">Message cannont be blank</p> : <></>}
                </div>
                <div>
                  <button type="submit"
